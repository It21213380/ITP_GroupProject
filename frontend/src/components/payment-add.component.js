...
export class CreatePayment extends Component {
    ...
    async onSubmit(e) {
        ...
        await axios
            .post('http://localhost:5000/api/payment/add', payment)
            .then(async res => {
                if (res.status === 200) {
                    this.clearData();
                    Swal.fire({
                                    ...
                                    <form className='px-12 py-12 border-2 rounded-lg shadow-md bg-gray-50' onSubmit={this.onSubmit} enctype="multipart/form-data">
                                        <div className="">
                                            ...
                                            <div className="grid grid-cols-2 gap-4 form-group">
                                                <div className="">
                                                    <label className='block mb-2 text-lg font-medium text-gray-900 dark:text-black'>Payment Name : </label>
                                                    <input type="text"
                                                        required
                                                        placeholder=''
                                            ...
                                            <div className="text-center align-middle form-group">
                                                ...
                                                <Link className='font-semibold text-white no-underline' to={"/payment"}>
